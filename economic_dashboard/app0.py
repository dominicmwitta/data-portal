...
st.title("📊 Economic Indicators Database")
st.markdown("**Get data with ease!!**")
...
with tab_cpi:
    ...
    with col1:
        ...
        if use_date_range:
            ...
            start_y_cpi = st.number_input("Start year", 1960, 2050, 2020, key="cpi_start")
            start_m = None
    ...
    with col2:
        if use_date_range:
            ...
            end_y_cpi = st.number_input("End year", 1960, 2050, 2023, key="cpi_end")
            end_m = None
...
with tab_bop:
    ...
    with col1:
        ...
        if use_date_range_bop:
            ...
            start_y_bop = st.number_input("Start year", 1960, 2050, 2020, key="bop_start")
            start_m_bop = None
    ...
    with col2:
        if use_date_range_bop:
            ...
            end_y_bop = st.number_input("End year", 1960, 2050, 2023, key="bop_end")
            end_m_bop = None
